...
def scrape_get_links_from_twitch_inspect_html_old(scrapeurl):
    print("assign var1")
    my_cwd = os.getcwd()
    print("assign var2")
...
def scrape_transform_to_download_links(htmloftwitchinspect): #combined and replaced by scrape_get_links_from_twitch_inspect_html
    print("--------------------------------")
